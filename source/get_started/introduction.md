...
LibTraffic is an open source experimental toolkit in the field of traffic prediction, which aims to help researchers to one-click training and comparison of baseline models or custom models.
